...
public class Invincibility extends PowerUp implements CauseOfDeath {
	...
	public Invincibility(float size) {
		super(raw, "pixmaps/invincibility.png", 112.5f, size);
		canExplode = false;
		setRotDamping(1);
	}

	public String getCause() {
		return "a rogue powerup";
	}
